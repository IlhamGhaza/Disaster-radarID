      ...
      {isOpen && (
        ...
        >
          ...
          <div
            ...
            className="absolute right-0 top-0 h-full w-72 bg-[#0A0E16] border-l border-white/[0.06] shadow-2xl shadow-black/50 animate-[slideInRight_200ms_ease] overflow-y-auto"
          >
